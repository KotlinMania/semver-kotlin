...
This file is the quick-reference operating contract for semver-kotlin. The longer
...
semver-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`semver`](https://crates.io/crates/semver). Upstream Rust is the behavioral oracle while the
