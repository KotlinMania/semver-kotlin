...
kotlin {
    ...
    val xcf = XCFramework("Semver")

    macosArm64 {
        binaries.framework { baseName = "Semver"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Semver"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Semver"
        flattenPackage = "io.github.kotlinmania.semver"
    }

    android {
        namespace = "io.github.kotlinmania.semver"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "semver-kotlin", version.toString())

    pom {
        name.set("semver-kotlin")
        description.set("Kotlin Multiplatform port of dtolnay/semver - Parser and evaluator for Cargo's flavor of Semantic Versioning")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/semver-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/semver-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/semver-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/semver-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.semver.codeql
