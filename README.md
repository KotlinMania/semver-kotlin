...
Kotlin Multiplatform line-by-line clean-room port of the Rust crate [`semver`](https://crates.io/crates/semver).

> **Status: scaffold — porting has not started.** This repo currently contains build infrastructure only. The upstream Rust source for the `semver` crate will be cloned into `tmp/` (gitignored) when porting begins.

## About

SemVer 2.0 parser and comparator
...
Original work copyrighted by the upstream `semver` authors. Kotlin port copyright (c) 2026 Sydney Renee and The Solace Project.
